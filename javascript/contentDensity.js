 ...
 * (props, herbe, arbres animés). Ce multiplicateur permet de réduire la densité
 * de contenu pour viser 60 FPS sur machine faible, tout en gardant la pleine
 * richesse (densité 1.0) sur machine forte.
 *
 * Consommé par les overlays de contenu via scaledCount() au moment de la
 * génération (nombre de props/brins par tuile). Un changement dispatche
 * 'dorfromantik:content-density-changed' → scene.js reconstruit tous les overlays.
 *
 * Persisté en localStorage. N'affecte PAS le terrain, l'eau, les bâtiments,
 * les personnages (gameplay et systèmes instanciés déjà optimisés séparément).
 */
 ...
 * Les overlays l'utilisent à la place de leur compteur brut (props/brins).
 */
