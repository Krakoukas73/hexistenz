// ─── ambientSoundDesign.js — ambiance spatiale 3D (THREE.Audio) ─────────────
// Extrait de soundDesign.js le 2026-07-11 (découpage sans risque, cf. CONTEXT.md §21) :
// classe AmbientSoundDesign (corbeaux/oiseaux/village/plage/train/bateau, proximité
// caméra, mode chi-mai). Dépend de musicPlayer.js dans un seul sens (appelle
// setMusicDuck/setChiMaiMode) — jamais l'inverse. soundDesign.js reste un ré-export
// faîtier.
import * as THREE from 'https://cdn.jsdelivr.net/npm/three@0.160.0/build/three.module.js';
import { EDGE_ORDER, EDGE_TYPES, HEX_SIZE } from './config.js';
import { axialToWorld } from './hex.js';
import { getEdgeType } from './tileGenerator.js';
import { setMusicDuck, setChiMaiMode, weightedRandom } from './musicPlayer.js';
