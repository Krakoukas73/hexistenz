 ...
 * (props naturels, personnages, herbe, moutons). Persisté en localStorage.
 *
 * Réduire la densité allège le parcours du graphe (−29 % de nœuds à 0.4, surtout
 * les squelettes de personnages) et la charge GPU (vertices) → vise 60 FPS sur
 * machine faible. N'affecte pas le terrain, l'eau, les bâtiments (gameplay).
 */
...
export function createQualityUi() {
  ...
  hint.textContent = 'Moins de props/persos = plus de FPS. N’affecte pas le jeu.';
