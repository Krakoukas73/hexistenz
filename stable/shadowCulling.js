 ...
 * L'ancienne restore per-frame est remplacée par le cycle rebuild/applySceneShadowFlags.
 * @deprecated Ne fait plus rien — peut être supprimé avec les callsites.
 */
export function restoreShadowCulling() {
